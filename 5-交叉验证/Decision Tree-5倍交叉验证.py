...
# 初始化模型（修改为决策树）
model = DecisionTreeClassifier(max_depth=10, random_state=42)  # 设置决策树的最大深度
...
# --------------
import shap
explainer = shap.Explainer(model.predict, X,max_evals=15103)
