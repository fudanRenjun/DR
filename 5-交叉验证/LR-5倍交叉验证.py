...
# 加载CSV文件
data = pd.read_excel('E:/RS/糖网/XGB/糖网-xun-4.xlsx')
...
# 初始化逻辑回归模型
model = LogisticRegression(max_iter=1000, random_state=42)  # 设置最大迭代次数和随机种子
...
# 5. 保存为 Excel 文件
shap_top100.to_excel("E:/RS/组学/LR-shap_top100_features.xlsx", index=False)
